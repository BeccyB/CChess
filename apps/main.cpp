...
int main() {
    ...
    if (selection == 'H') {
        std::cout << "Help is coming..." << std::endl;  // How to operate our game ...                                  
        std::cout << "If you want to learn more about chess, read wikipedia: https://en.wikipedia.org/wiki/Chess. " << std::endl;
    }
